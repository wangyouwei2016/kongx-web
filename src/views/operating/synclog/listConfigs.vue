  ...
  <div>
      ...
      <template slot="expand" slot-scope="{row}">
        <el-table :data="expandTableData" style="width: 100%">
          ...
          <el-table-column label="同步对象列表">
            <item-tags :tags="row.services" v-if="logType==0" column="name" mode="view"></item-tags>
            <item-tags :tags="row.services" v-if="logType==1" column="paramKey" mode="view"></item-tags>
          </el-table-column>
        </el-table>
        <el-table :data="expandTableData" style="width: 100%">
    ...
    >
      <div style=" overflow-y:auto;  height:90%;">
        ...
        <json-viewer :value="currnetSyncConfig" :expand-depth="5" copyable sort></json-viewer>
      </div>
    </el-drawer>
  </div>
</template>
