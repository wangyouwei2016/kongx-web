...
import upholdCertificate from "./uphold-certificate";
import searchBanner from "@/components/searchBanner";
import { findAllEntities, entityRemove } from "@/api/gateway/certificates";
...
export default {
  ...
  data() {
    return {
      ...
      mode: "add",
      entityName: DIC.CERTIFICATES,
      pathKey: DIC.CERTIFICATES,
      labelArgs: {},
      path: {
        label: DIC.CERTIFICATES,
        key: DIC.CERTIFICATES,
        children: [
          {
            key: DIC.CERTIFICATES + "_add",
            label: "新建" + DIC.CERTIFICATES,
          },
          {
            key: DIC.CERTIFICATES + "_edit",
            label: "修改" + DIC.CERTIFICATES,
          },
          {
            key: DIC.CERTIFICATES + "_view",
            label: "查看" + DIC.CERTIFICATES,
          },
        ],
      },
    };
